...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses =
    'h-[42px] w-[200px] font-semibold text-base flex items-center justify-center transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed rounded-base';
